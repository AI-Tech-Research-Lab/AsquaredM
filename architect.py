...
class Architect(object):
    ...
    def step(self, input_train, target_train, input_valid, target_valid, eta, network_optimizer, epoch, unrolled, betadecay, sam):
        ...
        if sam:
            ...
            if unrolled: 
                ...
                self._backward_step(input_valid, target_valid, epoch, betadecay)
        self.optimizer.step()

    def _backward_step(self, input_valid, target_valid, epoch, betadecay):

        if betadecay: #Beta-DARTS
