...
python train_neighbors.py --dataset $dataset --arch $arch --arch_target $arch_target \
    --data ../datasets/$dataset --gpus $gpus \
    --save results/prova_darts_train_neighbors_dataset${dataset}_arch${arch}_radius${radius} \
