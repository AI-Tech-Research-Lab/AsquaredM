...
for seed in "${seeds[@]}"; do
    ...
    save_dir="${base_save_dir}_dataset${dataset}_sdarts_sam${sam}_rho${rho}_k_sam${k_sam}_seed${seed}"
    ...
    python sota/cnn/train_search.py --save $save_dir \
                    ...
                    --sam $sam --rho_alpha_sam $rho --w_nor $w_nor --k_sam $k_sam --perturb_alpha random
done