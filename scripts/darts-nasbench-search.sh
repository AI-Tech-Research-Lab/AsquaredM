...
data_aug=True
rho_alpha_sams=(1e-4 1e-2 1e-1)
epsilon_sam=1e-2
flood_level=0.0
wandb=True

for rho_alpha_sam in "${rho_alpha_sams[@]}"; do
        python train_search.py --nasbench --save results/nasbench_search_dataset${dataset}_betadecay${betadecay}_unrolled${unrolled}_data_aug${data_aug} \
