...
python nasbench201/train_search.py --nasbench --save results/nasbench_search_beta_flood_level$flood_level --dataset cifar10 \
                       ...
                       --beta --flood_level $flood_level --wandb