...
- profile_darts.py: contains methods to visualize path/histograms on DARTS
- profile_nasbench.py: contains methods to visualize path/histograms on NAS-Bench-201
