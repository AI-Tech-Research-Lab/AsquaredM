...
parser.add_argument('--data', type=str, default='/remote-home/share/share/dataset', help='location of the darts corpus')
...
parser.add_argument('--layers', type=int, default=9, help='total number of layers')  # 9
