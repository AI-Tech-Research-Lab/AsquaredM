...
class Cell(nn.Module):
  ...
  def __init__(self, genotype, C_prev_prev, C_prev, C, reduction, reduction_prev, affine=False, track_running_stats=True):
    super(Cell, self).__init__()

    self.bn_affine = affine
  ...
  def _compile(self, C, op_names, indices, concat, reduction):
    ...
    for name, index in zip(op_names, indices):
      ...
      op = OPS[name](C, C, stride, self.bn_affine, self.bn_track_running_stats)
      self._ops += [op]
